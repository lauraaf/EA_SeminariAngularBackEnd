...
exports.getEntries = {
    ...
    delParticipant: (idExp, idPart) => __awaiter(void 0, void 0, void 0, function* () {
        return yield types_d_experiencias_1.experienciasofDB.findByIdAndUpdate(idExp, { $pull: { participants: idPart } });
    }),
    ...
    findOwner: (id) => __awaiter(void 0, void 0, void 0, function* () {
        console.log(id);
        return yield types_d_experiencias_1.experienciasofDB.find({ owner: id });
    })
};

...
router.get('/owner/:name', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    console.log(req.params.name);
    const user = yield userServices.getEntries.findUserByUsername(req.params.name);
    const idUser = user === null || user === void 0 ? void 0 : user.id;
    console.log(user);
    const data = yield experienciasServices.getEntries.findOwner(idUser);
    return res.json(data);
}));

...
router.delete('/deleteExperiencia/:idUser/:idExp', async(req,res) => {
    const data = await userServices.getEntries.deleteExperiencia(req.params.idUser, req.params.idExp)
    return res.json(data);   
})
